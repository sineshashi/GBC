...
from .serializers import (
    CreateDistributorSerializer, CreatePrimaryDistributorSerializer, CreateRetailerSerializer,
    RetrieveDistributorSerializer, RetrieveRetailerSerializer, RetrievePrimaryDistributorSerializer,
    WalletSerializer, ListDistributorSerializer, ListRetailerSerializer
)
